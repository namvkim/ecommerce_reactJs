    ...
    return (
      <div className="booking_main">
        <form method="POST" action="" onSubmit={sendEmail}>
          ...
          {itemTerm.map((item, index) => {
            return (
              <div key={index}>
                ...
                <input
                  type="text"
                  name={`product_unitPrice${index + 1}`}
                  defaultValue={item.unitPrice}
                  hidden
                />
                <input
                  type="text"
                  name={`product_quantity${index + 1}`}
          ...
          <button type="submit" className="booking_ok">
            Booking
          </button>
        </form>
      </div>
