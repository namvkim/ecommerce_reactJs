    ...
    render() {
        return (
            <React.Fragment>
               ...
               <h3 style={{color: 'black'}}>Tất cả sản phẩm</h3>
            ...
            <React.Fragment>
                <div className="row khoangcach">
                    <div className="card" style={{ width: '300px' }}>
                        <img className="card-img-top" src={this.props.product.pics[0]} alt="Card image" style={{ width: '100%',height: '250px' }} />
                        
                        <div className="card-body">
                            <h4 className="card-title">{this.props.product.name}</h4>
                            <p className="card-text">{this.props.product.price}$</p>
                            <button className="index_tab-pane_btn" onClick={() => this.addToCart(this.props.product)} > Add to cart</button>
                            <button onClick={() => this.detail(this.props.product.id)}className="btn index_tab-pane_btn "data-toggle="modal"data-target="#exampleModalCenter">
                                Detail
                            </button>
