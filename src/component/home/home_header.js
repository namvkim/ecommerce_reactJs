            ...
            <div className="user-modal-container">
              ...
              <div id="login">
                <form className="form">
                  ...
                  <p className="fieldset">
                    <label
                      className="image-replace password"
              ...
              <div id="signup">
                <form className="form">
                  <p className="fieldset">
                    <label
                      className="image-replace username"
                  ...
                  <p className="fieldset">
                    <label
                      className="image-replace Address"
